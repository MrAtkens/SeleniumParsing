...
{
    public static class WMailServiceHelper
    {
        ...
        public static IWebDriver Authorize(SiteConfiguration siteConfiguration)
        {
            ...
            //Authorization
            driver.FindElement(By.Name("ulogin")).SendKeys(siteConfiguration.Username);
            driver.FindElement(By.Name("pass")).SendKeys(siteConfiguration.Password + Keys.Enter);
            return driver;
        }
